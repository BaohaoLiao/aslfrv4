...
class TFLiteModelv3(tf.Module):
    def __init__(self, model, preprocess_layer, start_token_id, end_token_id, pad_token_id, max_gen_length):
        super(TFLiteModelv3, self).__init__()
        self.start_token_id = start_token_id
        self.end_token_id = end_token_id
        self.pad_token_id = pad_token_id
        self.max_gen_length = max_gen_length
...
class TFLiteModelv4(tf.Module):
    def __init__(self, model, preprocess_layer, start_token_id, end_token_id, pad_token_id, max_gen_length):
        super(TFLiteModelv4, self).__init__()
        self.start_token_id = start_token_id
        self.end_token_id = end_token_id
        self.pad_token_id = pad_token_id
        self.max_gen_length = max_gen_length
    ...
    def __call__(self, inputs, training=False):
        ...
        for step in tf.range(max_gen_length-1):
            tf.autograph.experimental.set_loop_options(shape_invariants=[
                (beam_scores, tf.TensorShape([None, 1])),
                (best_sequence, tf.TensorShape([None, None])),
            ])
