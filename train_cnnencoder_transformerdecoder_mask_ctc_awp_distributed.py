...
from auto_ctc.conformerencoder_transformerdecoder_mask_droppath_ctc_awp import ConformerEncoderTransformerDecoder
...
def main():
    ...
    with strategy.scope():
        ...
        model.compile(optimizer=optimizer, loss_fn=loss_fn, ctc_loss_fn=CTCLoss, awp_delta=args.awp_delta)
