...
from mask.conformerencoder_transformerdecoder_mask_droppath_v2 import ConformerEncoderTransformerDecoder as ConformerEncoderTransformerDecoderDroppathv2
...
def parse_args():
    ...
    parser.add_argument("--model_arch",
                        choices=["transformer", "cnnencoder_transformerdecoder", "cnnencoderbn_transformerdecoder",
                                 ...
                                 "conformerencoder_transformerdecoder_droppathv2"],
                        default="transformer")
    ...
    with strategy.scope():
        if args.model_arch == "cnnencoder_transformerdecoder":
            ...
            model = ConformerEncoderTransformerDecoderDroppath(
                ...
                prenorm=args.prenorm,
                activation=args.activation)
        elif args.model_arch == "conformerencoder_transformerdecoder_droppathv2":
            model = ConformerEncoderTransformerDecoderDroppathv2(
                num_encoder_layers=args.num_encoder_layers,
                encoder_hidden_dim=args.encoder_hidden_dim,
                encoder_mlp_dim=args.encoder_mlp_dim,
                encoder_num_heads=args.encoder_num_heads,
